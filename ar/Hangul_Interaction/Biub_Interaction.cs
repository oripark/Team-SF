...
public class Biub_Interaction : MonoBehaviour
{
    ...
    void Update()
    {
        if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["A_target"])
        {
        ...
        else if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["Ya_target"])
        {
        ...
        else if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["Eo_target"])
        {
        ...
        else if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["Yeo_target"])
        {
        ...
        else if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["O_target"])
        {
        ...
        else if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["Yo_target"])
        {
        ...
        else if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["Wu_target"])
        {
        ...
        else if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["Yu_target"])
        {
        ...
        else if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["Ew_target"])
        {
        ...
        else if (create_dict.hangul_list["Biub_target"] && create_dict.hangul_list["Ee_target"])
        {
